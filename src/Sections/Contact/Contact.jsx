...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "ameenkamangar@gmail.com",
        href: "mailto:ameenkamangar@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+92 309 7482142",
        href: "tel:+923097482142",
    },
    {
        icon: MapPin,
        label: "Location",
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto animate-fade-in animation-delay-400 ">
                    ...
                    <div className="space-y-6 animate-fade-in animation-delay-400 ">
                        <div className="glass rounded-3xl p-8 border border-primary/30 hover:border-primary/70 trans-all duration-500">
                        ...
                        <div className="glass rounded-3xl p-8 border border-primary/30 hover:border-primary/70 trans-all duration-500">
                            ...
                            <p className="text-muted-foreground text-sm">
                                ...
                                Whether you need a Frontend Developer or a Video Editor,
                                let's talk!
                            </p>
                        </div>
                    </div>
